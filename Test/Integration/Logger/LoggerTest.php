...
namespace Klevu\Analytics\Test\Integration\Logger;

use Klevu\Analytics\Logger\Logger as AnalyticsLoggerVirtualType;
...
/**
 * @covers AnalyticsLoggerVirtualType::class
...
class LoggerTest extends TestCase
{
    ...
    private const XML_PATH_LOG_LEVEL = 'klevu/analytics/log_level';
    private const LOG_FILENAME_PATTERN = 'klevu-%s-analytics.log';
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = AnalyticsLoggerVirtualType::class; // @phpstan-ignore-line virtualType
